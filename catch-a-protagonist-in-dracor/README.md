...
The following notebook adapts the code of the respective modules to work with data returned by the DraCor API. The aim is to be able to recreate the *_chars.csv-files that were used in the study.
